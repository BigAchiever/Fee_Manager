						...
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								...
								while($row=$fees->fetch_assoc()):
									...
									$previous_fee = $row['previous_fee'];
									$discount = $row['discount'];
									$balance = $row['total_fee'] - $paid - $discount + $previous_fee;
								?>
								<tr>
									...
									<td class="text-right">
										<p> <b><?php echo number_format($previous_fee,2) ?></b></p>
									<td class="text-right">
										<p> <b><?php echo number_format($paid,2) ?></b></p>
									<td class="text-right">
										<p> <b><?php echo number_format($discount,2) ?></b></p>
									<td class="text-right">
